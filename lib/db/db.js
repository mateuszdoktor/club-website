let headlines = [
  {
    ...
    author: "John Doe",
    tags: ["Real Madrid", "Vinicius Jr", "La Liga"],
    commentsCount: 12,
    createdAt: new Date(),
  },
  {
    ...
    author: "Jane Smith",
    tags: ["Real Madrid", "Match Report", "Athletic Bilbao"],
    commentsCount: 8,
    createdAt: new Date(),
  },
  {
    ...
    author: "Mike Johnson",
    tags: ["Player Ratings", "Real Madrid", "Athletic Bilbao"],
    commentsCount: 5,
    createdAt: new Date(),
  },
  {
    ...
    description:
      "Mbappe returns to full training amidst heavy transfer speculation linking him to Real Madrid.",
    author: "Samantha Lee",
    tags: ["Mbappe", "Training", "Transfers"],
    commentsCount: 20,
    createdAt: new Date(),
  },
  {
    ...
    author: "David Brown",
    tags: ["Ancelotti", "Getafe", "Press Conference"],
    commentsCount: 4,
    createdAt: new Date(),
  },
];
